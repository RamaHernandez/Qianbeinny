	...
	<div class="container-fluid p-0 top-line bottom-line">
		<div class="row no-gutters">
			{% if has_contact_info and not is_order_cancellation %}
				<div class="col-md-4 bottom-line bottom-no-line-md right-line-md">
					{% if store.contact_intro %}
						<p class="p-3 m-0 bottom-line">{{ store.contact_intro }}</p>
					{% endif %}
			...
			{% if is_order_cancellation %}
				<div class="col-md-4 bottom-line bottom-no-line-md right-line-md">
					<div class="text-center text-md-left p-3">
					...
					{% if has_contact_info %}
						<h5 class="mb-3 mt-2 px-3">{{ 'Si tenés problemas con otra compra, contactanos:' | translate }}</h5>
			...
			<div class="col-md-5 right-line-md">
				{% if product %}  
					<div class="row align-items-center justify-content-md-left bottom-line no-gutters">
						<div class="col-auto">
			...
			{% endif %}
				...
				{% if is_order_cancellation_without_id %}
					<p class="p-3 bottom-line" data-component="order-cancellation-disclaimer">{{ "Si te arrepentiste de una compra, podés pedir la cancelación enviando este formulario <strong>con tu número de orden.</strong> Tenés como máximo hasta 10 días corridos desde que recibiste el producto." | translate }}</p>
				{% endif %}
				
				{% embed "snipplets/forms/form.tpl" with{form_id: 'contact-form', form_custom_class: 'js-winnie-pooh-form', form_action: '/winnie-pooh', submit_custom_class: 'btn-block btn-line mb-neg-1', submit_name: 'contact', submit_text: 'Enviar' | translate, data_store: 'contact-form' }  %}
					{% block form_body %}
