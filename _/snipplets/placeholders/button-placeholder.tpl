<div class="js-addtocart js-addtocart-placeholder btn {% if direct_add %}btn-small item-btn-quickshop{% else %}btn-primary{% endif %} btn-block btn-transition {{ custom_class }} disabled" style="display: none;">
    <div class="d-inline-block">
        ...
        <div class="js-addtocart-adding transition-container transition-icon">
            ...
            {% else %}
                {% include "snipplets/svg/spinner-third.tpl" with {svg_custom_class: "icon-inline icon-spin h3 mt-1"} %}
            {% endif %}
        </div>
    </div>
</div>