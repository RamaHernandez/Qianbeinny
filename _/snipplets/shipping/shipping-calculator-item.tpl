...
<li class="js-shipping-list-item radio-button-item p-3{% if not loop.first %} top-dashed-line{% endif %}" data-store="shipping-calculator-item-{{ option.code }}">
    <label class="js-shipping-radio radio-button list-item" data-loop="shipping-radio-{{loop.index}}" data-shipping-type="{% if pickup %}pickup{% else %}delivery{% endif %}" data-component="shipping.option">
        ...
        <div class="radio-button-content">
            ...
            <div class="radio-button-label">
                ...
                <div class="radio-button-text row no-gutters"> 
