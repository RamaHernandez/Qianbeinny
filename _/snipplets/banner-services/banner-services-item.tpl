<div class="swiper-slide col-auto col-md p-0{% if not loop.last %} right-line{% endif %}" data-transition="fade-in">
    {% if banner_services_url %}
        <a href="{{ banner_services_url | setting_url }}">
    {% endif %}
    <div class="row no-gutters h-100">
        <div class="col-auto h-100 icon-80px right-line">
            ...
            <div class="col p-3">
                <div class="align-item-middle">
                    {% if banner_services_title %}
                        <h3 class="h6 mb-2">{{ banner_services_title }}</h3>
                    {% endif %}
