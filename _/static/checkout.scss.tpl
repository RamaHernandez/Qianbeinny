...
.container {
  ...
  .row{
    ...
    .col-5,
    &.third-gutters .form-group,
    &.third-gutters .form-group.col-sm-12:last-child,
    &.third-gutters .form-group.col-12:last-child {
      padding: 0;
    }
    &.third-gutters .form-group:last-child {
      padding-left: 10px;
    }
  }
  .col-md-4 {
...
@media (min-width: $md) {
  ...
  .container {
    ...
    .row.third-gutters .form-group.col-sm-12:last-child {
      padding-left: 10px;
    }
    .col-md-8 {
      border-right: 1px solid $border-color;
